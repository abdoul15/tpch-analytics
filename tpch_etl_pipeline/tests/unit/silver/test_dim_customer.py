...
def test_dim_customer_transform(
    spark, sample_customer_data, sample_nation_data, sample_region_data
):
    ...
    with patch.object(DimCustomerSilverETL, 'extract_upstream') as mock_extract:
        ...
        result = dim_customer_etl.transform_upstream(
            dim_customer_etl.extract_upstream()
        )
