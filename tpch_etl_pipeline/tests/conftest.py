...
def sample_customer_data(spark):
    ...
    pandas_df = pd.DataFrame({
        ...
        'c_address': ['Address 1', 'Address 2', 'Address 3', 'Address 4', 'Address 5'],
        'c_nationkey': [1, 1, 2, 3, 3],
        'c_phone': ['123-456-7890', '234-567-8901', '345-678-9012', '456-789-0123', '567-890-1234'],
        'c_acctbal': [1000.0, 2000.0, 3000.0, 4000.0, 5000.0],
        'c_mktsegment': ['BUILDING', 'AUTOMOBILE', 'MACHINERY', 'HOUSEHOLD', 'BUILDING'],
...
def sample_orders_data(spark):
    ...
    pandas_df = pd.DataFrame({
        ...
        'o_comment': ['Comment 1', 'Comment 2', 'Comment 3', 'Comment 4', 'Comment 5']
    })
...
def sample_lineitem_data(spark):
    ...
    pandas_df = pd.DataFrame({
        ...
        'l_shipinstruct': ['DELIVER IN PERSON', 'TAKE BACK RETURN', 'DELIVER IN PERSON', 'NONE', 'NONE'],
...
def sample_part_data(spark):
    ...
    pandas_df = pd.DataFrame({
        ...
        'p_container': ['SMALL BOX', 'MEDIUM BOX', 'LARGE BOX', 'JUMBO BOX', 'WRAP CASE'],
        'p_retailprice': [100.0, 200.0, 300.0, 400.0, 500.0],
        'p_comment': ['Comment 1', 'Comment 2', 'Comment 3', 'Comment 4', 'Comment 5']
    })
...
def sample_supplier_data(spark):
    ...
    pandas_df = pd.DataFrame({
        ...
        's_address': ['Address 1', 'Address 2', 'Address 3', 'Address 4', 'Address 5'],
        's_nationkey': [1, 1, 2, 3, 3],
        's_phone': ['123-456-7890', '234-567-8901', '345-678-9012', '456-789-0123', '567-890-1234'],
...
def sample_partsupp_data(spark):
    ...
    pandas_df = pd.DataFrame({
        ...
        'ps_comment': ['Comment 1', 'Comment 2', 'Comment 3', 'Comment 4', 'Comment 5']
    })
...
def sample_wide_order_details(spark):
    ...
    pandas_df = pd.DataFrame({
        ...
        'customer_name': ['Customer 1', 'Customer 1', 'Customer 2', 'Customer 3', 'Customer 3'],
        'market_segment': ['BUILDING', 'BUILDING', 'AUTOMOBILE', 'MACHINERY', 'MACHINERY'],
