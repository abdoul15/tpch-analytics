...
def create_supply_chain_dashboard_view(
    supply_chain_metrics_data,
    storage_path='s3a://spark-bucket/delta/interface/supply_chain/dashboard',
):
    """
    ...
    renamed_data.write.format('delta').mode('overwrite').option(
        'path', storage_path
...
def create_supplier_performance_view(
    supply_chain_metrics_data,
    storage_path='s3a://spark-bucket/delta/interface/supply_chain/supplier_performance',
):
    """
...
def create_inventory_analysis_view(
    supply_chain_metrics_data,
    storage_path='s3a://spark-bucket/delta/interface/supply_chain/inventory_analysis',
):
    """
